import { ProductFilterValidator } from "@/app/_validators/product-validator";
import { db } from "@/db";
...
// set this by running the average script after you seeded the db
const AVG_PRODUCT_PRICE = 60;
